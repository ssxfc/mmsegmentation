...
data_root = '/home/dcd/zww/data/final_ebhi'
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        type='SegDataPreProcessor'),
    # TODO: 标准unet模型最后需要有一个卷积操作来实现最终的预测结果.
    decode_head = dict(
        type='MyUNetHead',
        in_channels=64,
        in_index=4,
...
work_dir = './work_dirs/my_unet_ebhi-224x224'
